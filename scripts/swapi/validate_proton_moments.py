...
def main():
    ...
    swapi_response = SWAPIResponse.from_files(
        azimuthal_transmission_path=_instrument_data / 'imap_swapi_azimuthal-transmission_20260425_v001.csv',
        central_effective_area_path=_instrument_data / 'imap_swapi_central-effective-area_20260425_v001.csv',
        passband_fit_coefficients_path=_instrument_data / 'imap_swapi_passband-fit-coefficients_20260425_v001.csv',
    )
